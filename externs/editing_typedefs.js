 ...
 * @return {boolean}
 */
editing.nodes.isDescendantOf = function() {};
 ...
 * @return {number}
 */
editing.nodes.nodeIndex: function(!Node): number,

/**
 * @param {!editing.EditingContext} context
 * @param {!editing.ReadOnlySelection} selection
 */
normalizeSelection = function(context, selection) {};

/**
 * @param {?Node} node
 * @return {?Node}
 */
editing.nodes.previousNode = function() {};
